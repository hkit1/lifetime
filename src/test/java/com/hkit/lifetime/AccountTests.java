...
public class AccountTests {
    ...
    public static MultiValueMap<String, String> createAccountInfo() {
        ...
        info.add("birth", faker.date().birthday().toLocalDateTime().format(DateTimeFormatter.ofPattern("yyyyMMdd")));
    ...
    void createAndLogin() throws Exception {
        ...
        mockMvc.perform(post("/api/account/check").param("id", info.getFirst("id")).with(csrf())).andExpect(status().isBadRequest());
    ...
    void updateAccount() throws Exception {
        ...
        mockMvc.perform(post("/api/account/update").params(info).with(csrf())).andExpect(status().isOk());
